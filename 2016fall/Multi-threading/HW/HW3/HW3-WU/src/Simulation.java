...
public class Simulation
{
    ...
    {         
        ...
        System.out.println("sold item count: " + AuctionServer.getInstance().soldItemsCount());
        System.out.println("item unbid: " + AuctionServer.getInstance().itemUnbid(15));
        System.out.println("item price: " + AuctionServer.getInstance().itemPrice(15));
        System.out.println("bid status: " + AuctionServer.getInstance().checkBidStatus("Buyer2", 15));
